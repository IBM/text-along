...
import bias_tagger_detection.seq2seq.transformer_decoder as trans_decoder
from bias_tagger_detection.shared.beam import Beam
...
class Seq2Seq(nn.Module):
    def __init__(self, vocab_size, hidden_size, emb_dim, dropout, tok2id):
        ...
        if ARGS.transformer_decoder:
            self.decoder = trans_decoder.TransformerDecoder(
