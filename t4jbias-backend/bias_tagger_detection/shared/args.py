...
parser.add_argument(
    "--corenlpurl",
    help="You running corenlp server. This is needed to tokenise for the tagger model",
...
parser.add_argument("--debug_skip", 
    ...
    action="store_true")
parser.add_argument(
    "--arte_user", default='', type=str,
    help="artifactory user for model download",
)
parser.add_argument(
    "--arte_pwd", default='', type=str,
    help="artifactory user password for model download",
)

parser.add_argument(
    "--tagger_model_path", default='../models/tagger_model_2.ckpt', type=str,
    help="name of the tagger model to download from artifactory",
)

parser.add_argument(
    "--costar_model_path", default='../models/stereotype-models', type=str,
    help="name of the costar model to download from artifactory",
)

parser.add_argument(
    "--debias_model_path", default='../models/debiaser_20.ckpt', type=str,
    help="name of the debiasing model to download from artifactory",
)
